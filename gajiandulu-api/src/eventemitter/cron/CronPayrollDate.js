    ...
    this.observable.addListener(EVENT.CRON_PAYROLL_DATE, async () => {
      ...
      for (const data of cronCandidates) {
        ...
        const compose = {
          ...
          message: `Tanggal masuk kerja telah berubah dari tanggal ${
            oldPayrollDate[0].payroll_date
          } menjadi ${data.payroll_date}`
        };
      ...
      for (const data of notification) {
        ...
        await oneSignalApi.post('/notifications', payload, {
          headers: {
